...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && DEBIAN_FRONTEND=noninteractive apt-get -y install lsb-release apt-transport-https ca-certificates gnupg-agent curl apt-utils
